#!/usr/bin/env python3
"""
Recupero codici sconto LaFeltrinelli da shopilo.it
Sursa: https://shopilo.it/negozi/lafeltrinelli.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/lafeltrinelli.it"
STORE_NAME = "LaFeltrinelli"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per LaFeltrinelli da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-lafeltrinelli)"
    }
    try:
